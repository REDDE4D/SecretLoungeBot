...
export const kickUser = asyncHandler(async (req, res) => {
  ...
  const result = await userService.kickUser(id, reason, req.user.id);
...
export const removeRestrictions = asyncHandler(async (req, res) => {
  ...
  const result = await userService.removeRestrictions(id, req.user.id);
...
export const warnUser = asyncHandler(async (req, res) => {
  ...
  const result = await userService.warnUser(id, reason, req.user.id);
